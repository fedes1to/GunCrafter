	...
	internal class SnapshotManager
	{
		internal class OpenResponse : BaseReferenceHolder
		{
			...
			internal string ConflictId()
			{
				...
				return PInvokeUtilities.OutParamsToString(_003CConflictId_003Em__0);
			}
			...
			[CompilerGenerated]
			private UIntPtr _003CConflictId_003Em__0(byte[] out_string, UIntPtr out_size)
			{
		...
		internal class FetchAllResponse : BaseReferenceHolder
		{
			...
			{
				return PInvokeUtilities.ToEnumerable(GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_FetchAllResponse_GetData_Length(SelfPtr()), _003CData_003Em__0);
			}
			...
			[CompilerGenerated]
			private NativeSnapshotMetadata _003CData_003Em__0(UIntPtr index)
			{
		...
		internal class ReadResponse : BaseReferenceHolder
		{
			...
			internal byte[] Data()
			{
				...
				return PInvokeUtilities.OutParamsToArray<byte>(_003CData_003Em__0);
			}
			...
			[CompilerGenerated]
			private UIntPtr _003CData_003Em__0(byte[] out_bytes, UIntPtr out_size)
			{
		...
		internal void FetchAll(Types.DataSource source, Action<FetchAllResponse> callback)
		{
			...
			GooglePlayGames.Native.Cwrapper.SnapshotManager.FetchAllCallback callback2 = _003C_003Ef__mg_0024cache1;
			if (_003C_003Ef__mg_0024cache0 == null)
			{
				_003C_003Ef__mg_0024cache0 = FetchAllResponse.FromPointer;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_FetchAll(self, source, callback2, Callbacks.ToIntPtr(callback, _003C_003Ef__mg_0024cache0));
		}
		...
		internal void SnapshotSelectUI(bool allowCreate, bool allowDelete, uint maxSnapshots, string uiTitle, Action<SnapshotSelectUIResponse> callback)
		{
			...
			{
				_003C_003Ef__mg_0024cache3 = InternalSnapshotSelectUICallback;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotSelectUICallback callback2 = _003C_003Ef__mg_0024cache3;
			if (_003C_003Ef__mg_0024cache2 == null)
			{
				_003C_003Ef__mg_0024cache2 = SnapshotSelectUIResponse.FromPointer;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_ShowSelectUIOperation(self, allowCreate, allowDelete, maxSnapshots, uiTitle, callback2, Callbacks.ToIntPtr(callback, _003C_003Ef__mg_0024cache2));
		}
		...
		internal void Open(string fileName, Types.DataSource source, Types.SnapshotConflictPolicy conflictPolicy, Action<OpenResponse> callback)
		{
			...
			{
				_003C_003Ef__mg_0024cache5 = InternalOpenCallback;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.OpenCallback callback2 = _003C_003Ef__mg_0024cache5;
			if (_003C_003Ef__mg_0024cache4 == null)
			{
				_003C_003Ef__mg_0024cache4 = OpenResponse.FromPointer;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_Open(self, source, fileName, conflictPolicy, callback2, Callbacks.ToIntPtr(callback, _003C_003Ef__mg_0024cache4));
		}
		...
		internal void Commit(NativeSnapshotMetadata metadata, NativeSnapshotMetadataChange metadataChange, byte[] updatedData, Action<CommitResponse> callback)
		{
			...
			UIntPtr data_size = new UIntPtr((ulong)updatedData.Length);
			if (_003C_003Ef__mg_0024cache7 == null)
			{
				_003C_003Ef__mg_0024cache7 = InternalCommitCallback;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.CommitCallback callback2 = _003C_003Ef__mg_0024cache7;
			if (_003C_003Ef__mg_0024cache6 == null)
			{
				_003C_003Ef__mg_0024cache6 = CommitResponse.FromPointer;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_Commit(self, snapshot_metadata, metadata_change, updatedData, data_size, callback2, Callbacks.ToIntPtr(callback, _003C_003Ef__mg_0024cache6));
		}
		...
		internal void Resolve(NativeSnapshotMetadata metadata, NativeSnapshotMetadataChange metadataChange, string conflictId, Action<CommitResponse> callback)
		{
			...
			{
				_003C_003Ef__mg_0024cache9 = InternalCommitCallback;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.CommitCallback callback2 = _003C_003Ef__mg_0024cache9;
			if (_003C_003Ef__mg_0024cache8 == null)
			{
				_003C_003Ef__mg_0024cache8 = CommitResponse.FromPointer;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_ResolveConflict(self, snapshot_metadata, metadata_change, conflictId, callback2, Callbacks.ToIntPtr(callback, _003C_003Ef__mg_0024cache8));
		}
		...
		internal void Read(NativeSnapshotMetadata metadata, Action<ReadResponse> callback)
		{
			...
			{
				_003C_003Ef__mg_0024cacheB = InternalReadCallback;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.ReadCallback callback2 = _003C_003Ef__mg_0024cacheB;
			if (_003C_003Ef__mg_0024cacheA == null)
			{
				_003C_003Ef__mg_0024cacheA = ReadResponse.FromPointer;
			}
			GooglePlayGames.Native.Cwrapper.SnapshotManager.SnapshotManager_Read(self, snapshot_metadata, callback2, Callbacks.ToIntPtr(callback, _003C_003Ef__mg_0024cacheA));
		}
