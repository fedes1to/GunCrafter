...
namespace GooglePlayGames.Native.PInvoke
{
	internal class NativeQuestMilestone : BaseReferenceHolder, IQuestMilestone
	{
		...
		public string EventId
		{
			get
			{
				return PInvokeUtilities.OutParamsToString(_003Cget_EventId_003Em__1);
			}
		}
		...
		public string QuestId
		{
			get
			{
				return PInvokeUtilities.OutParamsToString(_003Cget_QuestId_003Em__2);
			}
		}
		...
		public byte[] CompletionRewardData
		{
			get
			{
				return PInvokeUtilities.OutParamsToArray<byte>(_003Cget_CompletionRewardData_003Em__3);
			}
		}
		...
		[CompilerGenerated]
		private UIntPtr _003Cget_EventId_003Em__1(byte[] out_string, UIntPtr out_size)
		{
			return QuestMilestone.QuestMilestone_EventId(SelfPtr(), out_string, out_size);
		}

		[CompilerGenerated]
		private UIntPtr _003Cget_QuestId_003Em__2(byte[] out_string, UIntPtr out_size)
		{
			return QuestMilestone.QuestMilestone_QuestId(SelfPtr(), out_string, out_size);
		}

		[CompilerGenerated]
		private UIntPtr _003Cget_CompletionRewardData_003Em__3(byte[] out_bytes, UIntPtr out_size)
		{
